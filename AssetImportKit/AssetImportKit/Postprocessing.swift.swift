...
public struct PostProcessSteps: OptionSet {
     ...
     * (if you support lines and points for rendering but don't
     *    want the degenerates)
     *
     *   Specify the AssetImporter_Process_FindDegenerates flag.
     *
     ...
     *       @code AssetImporter_PrimitiveType_POINTS | aiPrimitiveType_LINES
     ...
     * be recomputed, i.e. by the AssetImporter_Process_GenSmoothNormals flag.<br>
